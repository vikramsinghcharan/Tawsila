...
- (void)setupView {
	...
	_highlightedStar = [UIImage imageNamed:@"starFill.png"];
    
    if ([[[NSUserDefaults standardUserDefaults]objectForKey:@"LanguageSelected"] isEqualToString:@"ar"])
    {
        _star = [UIImage imageNamed:@"starFill.png"];
        _highlightedStar = [UIImage imageNamed:@"star.png"];
    }
