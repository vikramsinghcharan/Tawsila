...
+( struct CLLocationCoordinate2D )cordinateFromLat:(NSString *)lat long:(NSString *)lon
{
    CLLocationCoordinate2D cordnate;
    
    cordnate.latitude = lat.doubleValue;
    cordnate.longitude = lon.doubleValue;
